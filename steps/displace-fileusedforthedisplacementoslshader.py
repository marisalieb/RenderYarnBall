...
ri.Pattern(
    "disp", "disp",
    {
        ...
        "float repeatV1": [1.0],  # Repeat factor for the first spiral
        "float scale2": [0.02],  # Smaller displacement for the second spiral
        "float repeatU2": [25.5],  # Repeat factor for the second spiral (smaller)
        "float repeatV2": [2],  # Repeat factor for the second spiral (smaller)
    }
)
