...
def main(
    ...
    for i in range(num_tori):
        ...
        # !!!!
        generateHair(hair_pts, hair_widths, hair_npts, count=0, major_radius=effective_major, minor_radius=effective_minor, hair_length=hairlength, hair_width=hairwidth)
