...
def main(
    ...
    num_tori3 = 200 # 150 # 214 #214  # 213 #50 
    ...
    for i in range(num_tori3):
        ...
        hairlength = 0.0075 *hair_scale * 3
    ...
    # NEW BALL
    num_tori4 = 150 # 150 # 214 #214  # 213 #50 
    rmaj_values = np.linspace(.8, 1.1, num_tori4)


    ri.Translate(0.1, 0,-0.05)
    ...
    for i in range(num_tori4):
        ...
        ri.Pattern(
            "disp", "disp",
            {
                "float scale1": [.004935],  # Larger displacement for the first spiral
    ...
    # for i, ((tx, ty, tz), (rx, ry, rz)) in enumerate(zip(manual_positions, manual_rotations)):
        ...
        ri.Pattern(
            "disp", "disp",
            {
                "float scale1": [.00493],  # Larger displacement for the first spiral
