...
def main(
    ...
    for i in range(num_tori3):
        ...
        ri.Pattern(
            "spiralColour", "spiralColour",
            {
                ...
                "float repeatV": [-15.0],  # Repeat factor for the first spiral
    ...
    random.seed(7)  # makes your randomness repeatable across runs
    ...
    for i in range(num_tori4):
        ...
        ri.Pattern(
            "disp", "disp",
            {
                "float scale1": [.0035],  # Larger displacement for the first spiral
                "float repeatU1": [230],  # Repeat factor for the first spiral
        ...
        effective_minor = 0.034181251 * 0.40510 * .125
        hairlength = 0.0075 *hair_scale * 1
