...
def main(
    ...
    for i in range(num_tori):
        ...
        ri.Pattern(
            ...
            {
                "float scale1": [.00],  # Larger displacement for the first spiral
                "float repeatU1": [30],  # Repeat factor for the first spiral
                "float repeatV1": [30.0],  # Repeat factor for the first spiral
        ...
        ri.Pattern(
            "spiralColour", "spiralColour",
            {
                ...
                "float repeatU": [.8],  # Repeat factor for the first spiral
                "float repeatV": [.8],  # Repeat factor for the first spiral
