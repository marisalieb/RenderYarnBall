...
ri.Pattern(
    "check", "check",
    {
        "float repeatU": [10],  # Number of times the pattern repeats around the torus
        "float repeatV": [1.0],  # Vertical repetition along the torus
        "float noiseScale": [0.1],  # Noise scale
        "float width": [0.1],  # Width of the stripe
        "color darkColor": [0.0, 0.0, 0.0],  # Dark color
        "color lightColor": [1.0, 1.0, 1.0]  # Light color
    }
)
