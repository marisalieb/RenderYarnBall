...
def main(
    ...
    ri.Rotate(-5, 1, 0, 0)          # Camera rotation; value, x, y, z
    ri.Translate(0, .5, 2)      # Camera position (focusDistance should match if you want to focus here)
    ...
    # yarn ball
    # Add small core sphere (darker green)

    ri.TransformBegin()
    ri.Translate(0.3, -1, -0.8)
    ri.AttributeBegin()
